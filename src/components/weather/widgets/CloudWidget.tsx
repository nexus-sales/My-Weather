        ...
        <div className="relative w-24 h-24 flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-2xl font-outfit font-black text-white leading-none">
              {coverage}<span className="text-[10px] text-white/65">%</span>
            </span>
            <span className="text-[7px] font-inter text-xs text-white/60 uppercase tracking-tighter mt-1">{status}</span>
          </div>
