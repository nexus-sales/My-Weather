...
const LEVELS = [
  { max: 20, label: 'Bajo', color: '#00ff88' },
  { max: 50, label: 'Moderado', color: '#ffcc00' },
  { max: 200, label: 'Alto', color: '#ff8c35' },
  { max: Infinity, label: 'Muy Alto', color: '#ff3e3e' },
];
...
export default function PollenWidget({ alder, birch, grass, dataQuality, source }: PollenWidgetProps) {
  const species = [
    { label: 'Aliso', value: alder },
    { label: 'Abedul', value: birch },
    { label: 'Gramíneas', value: grass },
  ];
